...
function orderedIds(item, modelKey) {
  return [...item?.results?.[modelKey] || []].sort((left, right) => Number(left.rank) - Number(right.rank)).map((result) => result.sampleId);
}
...
export default function LogoBriefDesk() {
  ...
  const present = (item, modelKey = activeModelKey) => void run(async () => {
    const modelName = props.models?.[modelKey] || modelKey;
    await showResults(orderedIds(item, modelKey), {
      focus: false,
      source: `${modelName} \xB7 ${item.label} \xB7 Top 5 of ${sampleCount} logos`
    });
    await setSelection(visibleTargetIds(item, modelKey));
    await patchState({ activeCaseId: item.id, activeModelKey: modelKey });
  });
  if (!active) {
    return /* @__PURE__ */ React.createElement(Panel, null, /* @__PURE__ */ React.createElement("div", { className: "lb-root" }, "No Logo Search cases are available."));
  }
  ...
  return /* @__PURE__ */ React.createElement(Panel, null, /* @__PURE__ */ React.createElement("div", { className: "lb-root" }, /* @__PURE__ */ React.createElement("style", null, `
        ...
        `), /* @__PURE__ */ React.createElement("header", { className: "lb-header" }, /* @__PURE__ */ React.createElement("span", { className: "lb-kicker" }, "Creative brief retrieval"), /* @__PURE__ */ React.createElement("h2", null, "Which logos make the first review screen?"), /* @__PURE__ */ React.createElement("p", null, "Choose a brief, compare the shortlist, and inspect the catalog\u2019s style coverage.")), /* @__PURE__ */ React.createElement("nav", { className: "lb-cases", "aria-label": "Creative briefs" }, cases.map((item, index) => /* @__PURE__ */ React.createElement(
    "button",
    {
      key: item.id,
      type: "button",
    ...
    /* @__PURE__ */ React.createElement("span", { className: "lb-kicker" }, "Brief ", String(index + 1).padStart(2, "0"), " \xB7 ", item.shortLabel),
    /* @__PURE__ */ React.createElement("strong", null, item.label),
    /* @__PURE__ */ React.createElement("small", null, "Exact target: H3 #", item.target.hyper3Rank, " \xB7 CLIP #", item.target.clipRank)
  ))), /* @__PURE__ */ React.createElement("section", { className: "lb-query" }, /* @__PURE__ */ React.createElement("span", { className: "lb-kicker" }, "Creative brief"), /* @__PURE__ */ React.createElement("dl", { className: "lb-attrs", "aria-label": "Brief attributes" }, active.attributes.map((item) => /* @__PURE__ */ React.createElement("div", { className: "lb-attr", key: item.label }, /* @__PURE__ */ React.createElement("dt", null, item.label), /* @__PURE__ */ React.createElement("dd", null, item.value)))), /* @__PURE__ */ React.createElement("p", { className: "lb-business" }, active.business), /* @__PURE__ */ React.createElement("details", null, /* @__PURE__ */ React.createElement("summary", null, "Original catalog caption"), /* @__PURE__ */ React.createElement("blockquote", null, "\u201C", active.query, "\u201D"))), /* @__PURE__ */ React.createElement("section", { className: "lb-models", "aria-label": "Model result sets" }, ["hyper3", "clip"].map((modelKey) => {
    const modelRank = modelKey === "hyper3" ? active.target.hyper3Rank : active.target.clipRank;
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("span", { className: "lb-model-top" }, /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("i", { style: { background: modelColor(modelKey) } }), props.models?.[modelKey]), /* @__PURE__ */ React.createElement("strong", { style: { color: modelColor(modelKey) } }, "#", modelRank)),
      /* @__PURE__ */ React.createElement("small", null, "exact asset rank \xB7 top 5 of ", sampleCount, " logos"),
      /* @__PURE__ */ React.createElement("p", null, active.modelReadout[modelKey])
    );
  })), /* @__PURE__ */ React.createElement("div", { className: "lb-active-proof" }, /* @__PURE__ */ React.createElement("strong", null, props.models?.[activeModelKey], " result set"), /* @__PURE__ */ React.createElement("br", null), "Exact target rank #", rank, " of ", sampleCount, ". ", rank <= 5 ? "The target is marked in the shortlist." : "The target is outside the visible shortlist."), /* @__PURE__ */ React.createElement("div", { className: "lb-actions" }, /* @__PURE__ */ React.createElement(
    "button",
    {
      type: "button",
      className: "lb-action",
      ...
      onClick: () => void run(async () => {
        await showResults([active.target.sampleId], {
          focus: false,
          source: `${active.label} \xB7 exact target`
        });
